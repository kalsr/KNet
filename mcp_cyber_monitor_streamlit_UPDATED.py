...
# Fixed Full Code (`mcp_cyber_monitor_streamlit.py`)
...
from streamlit_autorefresh import st_autorefresh  # external component
...
# Trigger auto-refresh (external component)
...
# Logo + Title
# ---------------------------------
st.image("kalsnet_logo.png", width=180)  # Ensure logo file exists in repo root
