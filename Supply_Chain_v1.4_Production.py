...
div.stButton > button:nth-child(4) {background-color:#f97316; color:white; height:3em; width:12em; border-radius:8px; font-size:16px;}
...
with col4:
    if st.button("Clear Records"):
        st.session_state['sbom_df'] = pd.DataFrame()
