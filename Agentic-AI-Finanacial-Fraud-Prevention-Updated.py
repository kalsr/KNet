...
if not df.empty:
    ...
    # INTERACTIVE DATA TABLE WITH TOOLTIPS

    column_tooltips = {

        "Risk_Score": "Baseline risk score (0-100) based on transaction features",

        "Agent_Risk": "Adjusted by Agentic AI according to scenario multiplier",

        "Risk_Category": "Derived from Risk Score: Low, Medium, High",

        "Alert": "Decision based on Agentic Risk Score thresholds"
