...
<style>
  ...
  .zt-title {
      text-align: center; font-size: 3.0rem; font-weight: 900;
  ...
  .zt-tagline {
      text-align: center; color: #555; font-size: 0.95rem; margin-bottom: 22px;
  }
  .zt-hr { border: 3px solid #0047AB; margin: 12px 0 24px 0; }
