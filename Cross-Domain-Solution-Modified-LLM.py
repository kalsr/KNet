...
with tab_policy:
    ...
    st.caption(
        ...
        "landscape this kind of filter sits within. For an actual accredited deployment, consult your "
        "Authorizing Official (AO), Cross Domain Support Element (CDSE), and NCDSMO — this tab is "
        "informational only."
    )
    ...
    st.caption(
        ...
        "CNSSI No. 1253 + CDS Overlay; DISA DISN Connection Process Guide. This app is an educational demo "
        "and does not constitute, and cannot substitute for, an accredited CDS."
    )
