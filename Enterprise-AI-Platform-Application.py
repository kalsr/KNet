...
# Full Enterprise Version with Safe Reset
# ===============================================
...
# If reset requested, clear session state and rerun safely
...
# Reset button using session_state safely
if st.sidebar.button("Reset & Refresh Data"):
    st.session_state.reset_request = True
    st.experimental_rerun()  # Now safely triggered at top
