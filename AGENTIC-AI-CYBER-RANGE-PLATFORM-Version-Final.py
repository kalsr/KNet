...
st.markdown("""
**Explanation:**  
The MITRE ATT&CK Heatmap visualizes how frequently different attack techniques occur in the simulation.  
- **Purpose:** Helps trainees identify high-risk tactics and understand real-world attacker behaviors.  
- **Why Needed:** Provides a structured view of attack patterns and maps them to MITRE techniques, enhancing threat intelligence and detection strategies.
""")
...
st.markdown("""
**Explanation:**  
The Network Attack Graph shows how attacks propagate across network nodes.  
- **Purpose:** Visualizes connections between systems and potential attack paths.  
- **Why Needed:** Helps trainees identify critical nodes and prioritize defense measures for network segmentation and protection.
""")
...
st.markdown("""
**Explanation:**  
This simulation tracks how attacks move through the network over time.  
- **Purpose:** Understand speed, reach, and potential impact of attacks.  
- **Why Needed:** Allows trainees to experiment with containment strategies and visualize risk propagation in real time.
""")
...
st.markdown("""
**Explanation:**  
The 3D Cyber Kill Chain visualizes the sequential stages of a cyber attack.  
- **Purpose:** Helps trainees understand each step attackers take to compromise systems.  
- **Why Needed:** Highlights intervention points where security teams can detect and disrupt attacks, enhancing defensive strategies.
""")
...
with col4:
    if st.button("Incident Response"):
        ...
        if attack:
            ...
            st.write("""Incident Response Steps:
