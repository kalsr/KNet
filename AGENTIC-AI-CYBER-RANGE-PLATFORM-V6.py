...
# ============================================================
# AGENTIC AI CYBER RANGE PLATFORM – VERSION 6
...
Agentic AI Cyber Range Platform – Version 6
<br>
AI Driven Cyber Defense & Training Environment
<br>
Developed by Randy Singh – Kalsnet (KNet) Consulting Group
</h1>
...
st.subheader("Attack Propagation Timeline")
...
# ---------------------------------------------------------
# DARK WEB THREAT SIMULATION
# ---------------------------------------------------------

st.subheader("Dark Web Threat Monitoring")

darkweb=[

"Exploit kit for new vulnerability advertised",
"Leaked corporate credentials found",
"APT actor discussing upcoming campaign",
"Malware source code leaked",
"Zero-day exploit for sale"

]

for i in range(3):
    st.warning(random.choice(darkweb))
...
with col3:
    ...
    if st.button("SOC Copilot") and "last_attack" in st.session_state:
        ...
        st.warning("SOC AI analyzing threat")
...
with col5:
    ...
    if st.button("Threat Hunter") and "last_attack" in st.session_state:
        ...
        st.info("Threat hunting across logs")
