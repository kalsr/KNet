...
# ============================================================
# FEDRAMP / NIST CONTROLS (EXTENDED)
# ============================================================
fedramp_controls = {
...
• Enforcing continuous monitoring (AU-6, SI-7)  
• Mapping threats to NIST 800-53 security controls  
• Demonstrating incident detection & response workflows (IR-4)  
• Supporting audit logging, evidence export, and risk scoring  
• Enabling boundary protection, access control & vulnerability tracking  

This platform supports **ATO readiness**, **POA&M reporting**, and **DoD Zero Trust principles**.
""")
...
if mode == "Commercial SOC":
    ...
    st.markdown(f"""
**Sector-Specific Coverage for {sector}:**

• Real-time threat detection  
• Regulatory mapping (PCI-DSS, HIPAA, SOX, GLBA)  
• Incident prioritization & severity scoring  
• Exportable compliance evidence  
• Executive & auditor-ready dashboards
""")
