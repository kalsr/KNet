...
st.title("Agentic-AI Autonomous Data Analyst — Developed By Randy Singh")
st.write("An Orchestrator which Coordinates Small Specialized Autonomous Agents (Ingestor, Cleaner, Summarizer, Anomaly Detector, Segmenter, Modeler, Reporter).")
...
with colD:
    reset_btn = st.button("Reset / Clear Data", key="reset")
...
if export_btn and "df" in st.session_state and st.session_state["df"] is not None:
